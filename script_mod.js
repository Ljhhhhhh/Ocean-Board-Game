        ...
        if (!gameState.selectedOption && !gameState.factShown) {
                    ...
                    if (year4Option) {
                        ...
                        if (year4Event) {
                            ...
                            if (selectedOption && selectedOption.nextYear7Lock) {
                                ...
                                console.log("第七年锁定选项:", lockedOptions);
                            }
                        }
                    }
                }
                    ...
                    if (year5Option) {
                        ...
                        if (year5Event) {
                            ...
                            if (selectedOption && selectedOption.nextYear9Lock) {
                                ...
                                console.log("第九年锁定选项:", lockedOptions);
                            }
                        }
                    }
                }
            ...
            if (gameState.gameMetrics.year === 7 || gameState.gameMetrics.year === 9) {
                ...
                if (gameState.gameMetrics.year === 7) {
                    ...
                    const selectedOption = year4Event.options.find(opt => opt.id === year4Option);
                    if (selectedOption) {
                        lockInfo.textContent = `基于你在第4年的选择 (选项${year4Option})，部分选项已被锁定`;
                    }
                    ...
                    const selectedOption = year5Event.options.find(opt => opt.id === year5Option);
                    if (selectedOption) {
                        lockInfo.textContent = `基于你在第5年的选择 (选项${year5Option})，部分选项已被锁定`;
                    }
                }
            ...
            gameState.currentEvent.options.forEach(option => {
                ...
                // 增强选项卡的视觉效果和交互动画
                optionCard.style.backgroundColor = selectedOptionId === option.id ? '#3B82F6' : (isLocked ? '#E5E7EB' : '#F9FAFB');
                optionCard.style.color = selectedOptionId === option.id ? '#fff' : (isLocked ? '#9CA3AF' : '#1F2937');
                ...
                optionCard.addEventListener('click', () => {
                    ...
                    setTimeout(() => {
                        ...
                        Array.from(optionsContainer.children).forEach(child => {
                            ...
                            child.style.backgroundColor = childIsLocked ? '#E5E7EB' : '#F9FAFB';
                            child.style.color = childIsLocked ? '#9CA3AF' : '#1F2937';
                ...
                // 在第七年和第九年自动选择这个选项，因为只会有一个选项可用
                if ((gameState.gameMetrics.year === 7 || gameState.gameMetrics.year === 9) && lockedOptions.length > 0) {
                    setTimeout(() => {
                        // 触发点击事件
                        optionCard.click();
                    }, 500);
