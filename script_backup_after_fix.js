document.addEventListener('DOMContentLoaded', function() {
    ...
    function renderGameEndScreen() {
        ...
        logoImg.innerHTML = `<img src="logo.svg" alt="Ocean of Possibilities Logo" style="width: 100px; height: 100px; filter: drop-shadow(0 4px 8px rgba(99, 164, 245, 0.3));">`;
        ...
        const endingIconEl = document.createElement('div');
        endingIconEl.textContent = endingIcon;
        endingIconEl.style.fontSize = '4rem';
        endingIconEl.style.marginBottom = '0.75rem';
        endingIconEl.style.animation = 'pulseEnd 3s infinite ease-in-out';
        ...
        iconContainer.appendChild(endingIconEl);
        ...
        subtitleEl.style.fontSize = '1.3rem';
        subtitleEl.style.color = '#4B5563';
        subtitleEl.style.margin = '0 0 2rem 0';
