document.addEventListener('DOMContentLoaded', function() {
    ...
    function renderGameEndScreen() {
        ...
        // 获取最终的立场数值
        const indValue = gameState.gameMetrics.industrialStance;
        const ecoValue = gameState.gameMetrics.ecologicalStance;
        const valueDiff = Math.abs(indValue - ecoValue);
        ...
        } else if (indValue > ecoValue && valueDiff >= 30) {
        ...
        } else if (ecoValue > indValue && valueDiff >= 30) {
        ...
        // 添加logo
        const logo = document.createElement('div');
        logo.innerHTML = `<img src="logo.svg" alt="Ocean of Possibilities Logo" style="width: 100px; height: 100px; filter: drop-shadow(0 4px 8px rgba(99, 164, 245, 0.3));">`;
        logo.style.animation = 'floating 6s ease-in-out infinite';
        ...
        metricsContainer.style.margin = '0 auto 2rem auto';
        metricsContainer.style.backgroundColor = 'rgba(255, 255, 255, 0.7)';
        metricsContainer.style.padding = '1.5rem';
        metricsContainer.style.borderRadius = '1rem';
        metricsContainer.style.boxShadow = '0 4px 15px rgba(0,0,0,0.1)';
        
        // 指标标题
        const metricsTitle = document.createElement('h3');
        metricsTitle.textContent = 'Final City Metrics';
        metricsTitle.style.textAlign = 'center';
        metricsTitle.style.margin = '0 0 1rem 0';
        metricsTitle.style.color = endingColor;
        metricsTitle.style.fontSize = '1.25rem';
        ...
        indValueText.textContent = `${Math.round(gameState.gameMetrics.industrialStance)}%`;
        ...
        ecologicalLabel.style.marginTop = '1rem';
        ...
        const ecoValue = document.createElement('span');
        ecoValue.textContent = `${Math.round(gameState.gameMetrics.ecologicalStance)}%`;
        ecoValue.style.fontWeight = '700';
        
        ecologicalLabel.appendChild(ecoLabelText);
        ecologicalLabel.appendChild(ecoValue);
        
        const ecoBar = document.createElement('div');
        ecoBar.style.width = '100%';
        ecoBar.style.height = '1rem';
        ecoBar.style.backgroundColor = '#E5E7EB';
        ecoBar.style.borderRadius = '0.5rem';
        ecoBar.style.overflow = 'hidden';
        
        const ecoProgress = document.createElement('div');
        ecoProgress.style.width = `${gameState.gameMetrics.ecologicalStance}%`;
        ecoProgress.style.height = '100%';
        ecoProgress.style.backgroundColor = '#10B981';
        ecoProgress.style.borderRadius = '0.5rem';
        ...
        iconContainer.style.margin = '0.5rem 0';
        
        const icon = document.createElement('div');
        icon.textContent = endingIcon;
        icon.style.fontSize = '4rem';
        icon.style.marginBottom = '0.75rem';
        icon.style.animation = 'pulseEnd 3s infinite ease-in-out';
        ...
        endingBadge.style.fontSize = '1rem';
        ...
        iconContainer.appendChild(endingBadge);
        ...
        contentContainer.style.boxShadow = '0 10px 25px rgba(0, 0, 0, 0.1)';
        ...
        title.style.fontWeight = '700';
        title.style.color = endingColor;
        title.style.margin = '0 0 1rem 0';
        title.style.letterSpacing = '0.01em';
        
        // 副标题
        const subtitle = document.createElement('p');
        subtitle.textContent = endingDescription;
        ...
        divider.style.background = `linear-gradient(90deg, transparent, ${endingColor}, transparent)`;
        divider.style.margin = '0 auto 2rem auto';
        
        // 未来详情列表
        const detailsContainer = document.createElement('div');
        detailsContainer.style.textAlign = 'left';
        detailsContainer.style.marginBottom = '2rem';
        
        // 详情标题
        const detailsTitle = document.createElement('h3');
        detailsTitle.textContent = 'Your City\'s Legacy';
        detailsTitle.style.fontSize = '1.5rem';
        detailsTitle.style.color = endingColor;
        detailsTitle.style.margin = '0 0 1rem 0';
        ...
        endingDetails.forEach(detail => {
            ...
            item.style.padding = '0.5rem 0.75rem 0.5rem 2rem';
        ...
        restartBtn.style.backgroundColor = endingColor;
        ...
        restartBtn.addEventListener('mouseover', () => {
            ...
            restartBtn.style.boxShadow = `0 4px 12px 0 ${endingColor}40`;
        });
        ...
        endContainer.appendChild(iconContainer);
