document.addEventListener('DOMContentLoaded', function() {
    ...
    const eventsData = [
        {
            ...
            options: [
                {
                    id: "A",
                    text: "Build Large Harbor. Fisher credit -5. All other Personal Credit +5.",
                    effectsDisplay: "Fisher credit -5. All other Personal Credit +5.",
                    effects: { industrialStance: 20, ecologicalStance: 0 },
                    additionalDeck: 0
                },
                {
                    id: "B",
                    text: "Reject harbor proposal. No immediate Credit change.",
                ...
                {
                    id: "C",
                    text: "Build fishing infrastructure. Fisher Credit+5.",
        ...
        // 第二年大事件
        {
            ...
            options: [
                {
                    id: "A",
                    text: "Approve fossil fuel as the city's primary energy source. Politician +10 Credit, Business Owner +10 Credit.",
                ...
                {
                    id: "B",
                    text: "Invest in a wind farm project along the coast. All players +5 Credit.",
                ...
                {
                    id: "C",
                    text: "Develop a tidal energy facility using offshore currents. Scientist +5 Credit, Fisher –5 Credit.",
        ...
        // 第三年大事件
        {
            ...
            options: [
                {
                    id: "A",
                    text: "Build a waste-to-energy converter that burns trash to generate power. All players +5 Credit.",
                    effectsDisplay: "All players +5 Credit.",
                ...
                {
                    id: "B",
                    text: "Allocate land near the shore for a permanent coastal landfill. Business Owner +10 Credit, Politician –5 Credit.",
                    effectsDisplay: "Business Owner +10 Credit, Politician –5 Credit.",
                    effects: { industrialStance: 25, ecologicalStance: 0 },
                    additionalDeck: 0
                },
                {
                    id: "C",
                    text: "Establish a public recycling center and encouraging community involvement. Educator +10 Credit, Influencer +5 Credit.",
                    effectsDisplay: "Educator +10 Credit, Influencer +5 Credit.",
        ...
        // 第四年大事件
        {
            ...
            options: [
                {
                    id: "A",
                    text: "Enact strict animal protection laws that prohibit captivity and display. No immediate Credit change.",
                    effectsDisplay: "No immediate Credit change.",
                    effects: { industrialStance: 0, ecologicalStance: 10 },
                    additionalDeck: 0,
                ...
                {
                    id: "B",
                    text: "Legalize marine animal performances and displays for profit. Business Owner +5 Credit, Influencer +5 Credit.",
                    effectsDisplay: "Business Owner +5 Credit, Influencer +5 Credit.",
                ...
                {
                    id: "C",
                    text: "Build a research center for marine animal control and education. Educator +5 Credit, Scientist +5 Credit.",
                    effectsDisplay: "Educator +5 Credit, Scientist +5 Credit.",
        ...
        // 第五年大事件
        {
            ...
            options: [
                {
                    id: "A",
                    text: "Invest heavily in seawalls, floodgates, and emergency infrastructure. All players –20 Credit.",
                ...
                {
                    id: "B",
                    text: "Launch a public education campaign focused on disaster drills and awareness. Educator +5 Credit, all others –5 Credit.",
                    effectsDisplay: "Educator +5 Credit, all others –5 Credit.",
                    effects: { industrialStance: 0, ecologicalStance: 10 },
                    additionalDeck: 0,
                ...
                {
                    id: "C",
                    text: "Save funds for future use. No immediate Credit change.",
                    effectsDisplay: "No immediate Credit change.",
                    effects: { industrialStance: 5, ecologicalStance: 5 },
                    additionalDeck: 0,
        ...
        // 第六年大事件
        {
            ...
            options: [
                {
                    id: "A",
                    text: "Focus education on environmental ethics and marine conservation. Educator +5 Credit, Influencer +5 Credit.",
                ...
                {
                    id: "B",
                    text: "Promote urban growth and industrialization history in school programs. Politician +5 Credit, Business Owner +5 Credit.",
                ...
                {
                    id: "C",
                    text: "Prioritize science, critical thinking, and civic resilience in the curriculum. Scientist +5 Credit, Fisher +5 Credit.",
                    effectsDisplay: "Scientist +5 Credit, Fisher +5 Credit.",
                    effects: { industrialStance: 0, ecologicalStance: 5 },
                    additionalDeck: 0
                }
        ...
        // 第七年大事件
        {
            ...
            options: [
                {
                    id: "A",
                    text: "Designate a large offshore area as a marine protected zone. Fisher +10 Credit.",
                ...
                {
                    id: "B",
                    text: "Open a wild marine animal zoo for education and entertainment. Educator +10 Credit.",
                ...
                {
                    id: "C",
                    text: "Establish a marine animal research and monitoring center. Scientist +10 Credit.",
        ...
        // 第八年大事件
        {
            ...
            options: [
                {
                    id: "A",
                    text: "Host a high-tech exhibition focused on innovation and new advancements across industries. Business Owner +5 Credit, Influencer +5 Credit, Politician +5 Credit, Scientist +10 Credit.",
                ...
                {
                    id: "B",
                    text: "Celebrate marine culture with a local seafood and ocean-themed expo. Business Owner +5 Credit, Influencer +5 Credit, Politician +5 Credit, Fisher +10 Credit.",
                ...
                {
                    id: "C",
                    text: "Organize a city-wide arts and culture festival with community engagement. Business Owner +5 Credit, Influencer +5 Credit, Politician +5 Credit, Educator +10 Credit.",
        ...
        // 第九年大事件
        {
            ...
            options: [
                {
                    id: "A",
                    text: "Launch a rapid reconstruction campaign to restore heavily affected regions. Business Owner -15 Credit, Politician –15 Credit, all others –5 Credit.",
                ...
                {
                    id: "B",
                    text: "Evacuate residents from high-risk coastal areas and convert the coastline into a natural ecological buffer. All players –20 Credit.",
                    effectsDisplay: "All players –20 Credit.",
                    effects: { industrialStance: 0, ecologicalStance: 20 },
                    additionalDeck: 0
                },
                {
                    id: "C",
                    text: "Delay rebuilding due to funding and conflict. Reconstruction slows, but no clear plan emerges. Business Owner –20 Credit, Politician –20 Credit, all others –5 Credit.",
        ...
        // 第十年大事件
        {
            ...
            options: [
                {
                    id: "A",
                    text: "Join forces on industrial development and shared infrastructure. Business Owner +10 Credit, Politician +10 Credit, Influencer +10 Credit.",
                ...
                {
                    id: "B",
                    text: "Form a coastal environmental alliance for joint marine protection. Fisher +10 Credit, Educator +10 Credit, Scientist +10 Credit.",
                ...
                {
                    id: "C",
                    text: "Accept only limited trade cooperation and maintain full independence. All players +5 Credit.",
                    effectsDisplay: "All players +5 Credit.",
                    effects: { industrialStance: 10, ecologicalStance: 10 },
                    additionalDeck: 0
                }
    ...
    function renderStartScreen(screenElement) {
        ...
        buttonContainer.style.transitionDelay = '1s';
    ...
    function renderBackgroundStoryScreen(screenElement) {
        ...
        gameState.selectedCharacters.forEach(charId => {
            ...
            iconContainer.style.backgroundColor = '#2563EB';
    ...
    function renderMainGameScreen(screenElement) {
        ...
        if (!gameState.selectedOption && !gameState.factShown) {
            ...
            gameState.currentEvent.options.forEach(option => {
                ...
                // 增强选项卡的视觉效果和交互动画
                optionCard.style.backgroundColor = selectedOptionId === option.id ? '#3B82F6' : (lockedOptions.includes(option.id) ? '#E5E7EB' : '#F9FAFB');
                optionCard.style.color = selectedOptionId === option.id ? '#fff' : (lockedOptions.includes(option.id) ? '#9CA3AF' : '#1F2937');
                optionCard.style.border = '1px solid ' + (selectedOptionId === option.id ? '#3B82F6' : '#E5E7EB');
                ...
                optionCard.style.cursor = lockedOptions.includes(option.id) ? 'not-allowed' : 'pointer';
                optionCard.style.opacity = lockedOptions.includes(option.id) ? '0.6' : '1';
                optionCard.style.boxShadow = selectedOptionId === option.id ? '0 12px 24px 0 rgba(59,130,246,0.25)' : '0 2px 6px rgba(0,0,0,0.05)';
                optionCard.style.transform = selectedOptionId === option.id ? 'translateY(-8px)' : 'translateY(0)';
                
                // 悬停效果增强
                optionCard.addEventListener('mouseover', () => {
                    if (!lockedOptions.includes(option.id) && selectedOptionId !== option.id) {
                ...
                optionCard.addEventListener('mousedown', () => {
                    if (!lockedOptions.includes(option.id)) {
                ...
                optionCard.addEventListener('click', () => {
                    if (lockedOptions.includes(option.id)) return;
                    ...
                    setTimeout(() => {
                        ...
                        Array.from(optionsContainer.children).forEach(child => {
                            ...
                            if (idSpan) idSpan.style.color = '#3B82F6';
                            
                            // 更新效果描述颜色
                            const effectsP = child.querySelector('p:last-child');
                            if (effectsP) effectsP.style.color = '#6B7280';
                        });
                ...
                optionId.style.color = selectedOptionId === option.id ? '#fff' : '#3B82F6';
                ...
                optionEffects.style.color = selectedOptionId === option.id ? '#e0e7ef' : '#6B7280';
    ...
    function showGameOverModal() {
        ...
        modalOverlay.style.background = 'linear-gradient(120deg, rgba(59,130,246,0.15) 0%, rgba(34,197,94,0.10) 100%)';
        modalOverlay.style.transition = 'background 0.6s cubic-bezier(0.4,0,0.2,1), opacity 0.5s';
        ...
        desc.textContent = 'One of the stance values has reached 100%. All Credits will be reset to 0. You can continue the game.';
        ...
        btn.addEventListener('mouseover', () => {
            ...
            btn.style.boxShadow = '0 4px 12px 0 rgba(59,130,246,0.15)';
        });
        btn.addEventListener('mouseout', () => {
            btn.style.transform = 'scale(1)';
            btn.style.boxShadow = 'none';
    ...
    function renderGameEndScreen() {
        ...
        // 背景渐变
        gameContainer.style.background = 'linear-gradient(120deg, #DBEAFE 0%, #EFF6FF 100%)';
        ...
        endContainer.style.height = '100vh';
        endContainer.style.width = '100vw';
        endContainer.style.gap = '2.5rem';
        endContainer.style.animation = 'fadeInEnd 1.2s cubic-bezier(0.4,0,0.2,1)';
        ...
        icon.style.fontSize = '4rem';
        icon.style.marginBottom = '0.5rem';
        icon.style.animation = 'waveEnd 2.5s infinite ease-in-out';
        ...
        subtitle.textContent = 'You have completed Ocean of Possibilities.';
        ...
        // 说明
        const desc = document.createElement('p');
        desc.textContent = 'Thank you for guiding your city through 10 years of choices, challenges, and growth.';
        desc.style.fontSize = '1.1rem';
        ...
        restartBtn.style.padding = '0.9rem 3.5rem';
        restartBtn.style.fontSize = '1.25rem';
        restartBtn.style.borderRadius = '0.75rem';
        restartBtn.style.transition = 'transform 0.2s, box-shadow 0.2s';
        restartBtn.addEventListener('mouseover', () => {
            restartBtn.style.transform = 'scale(1.05)';
            restartBtn.style.boxShadow = '0 4px 12px 0 rgba(59,130,246,0.15)';
        });
        ...
        // 动画keyframes
        const style = document.createElement('style');
        style.textContent = `@keyframes fadeInEnd {from{opacity:0;transform:translateY(40px);}to{opacity:1;transform:translateY(0);}}
        @keyframes waveEnd {0%,100%{transform:translateY(0);}50%{transform:translateY(-12px);}}
        `;
        document.head.appendChild(style);

        endContainer.appendChild(icon);
        endContainer.appendChild(title);
        endContainer.appendChild(subtitle);
        endContainer.appendChild(desc);
